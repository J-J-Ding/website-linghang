                  ...
                  const handleOpen = async () => {
                    ...
                    try {
                      ...
                      if(currentSubRowId.value in subTableDataCache && currentSubFieldKey.value in subTableDataCache[currentSubRowId.value]){
                        ...
                        if(version.includes("L0")){
                          subTableFilterValue.value = {"领域":["01-L0光系统"]};
                        } else if(version.includes("L1")){
                          subTableFilterValue.value = {"领域":["02-L1"]};
                        } else if(version.includes("L2")){
                          subTableFilterValue.value = {"领域":["03-L2"]};
                        } else if(version.includes("支撑")){
                          subTableFilterValue.value = {"领域":["05-支撑"]};
                        } else if(version.includes("智控")){
                          subTableFilterValue.value = {"领域":["13-智能控制"]};
                        } else{
                          subTableFilterValue.value = {};
                        }
                      }
...
const onRowAiChat = async(rowData) => {
  ...
  // 清空故障情况
  /* Started by AICoder, pid:a4beaf93eeu88e61487309cbb0cdc50da773c3ff */
  if ("故障情况" in enhancedRowData) {
    enhancedRowData["故障情况"] = '';
  }
  /* Ended by AICoder, pid:a4beaf93eeu88e61487309cbb0cdc50da773c3ff */
