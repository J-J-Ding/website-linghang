<template>
  <div class="component-main">
    <t-tabs v-model="tabValue" theme="card" @change="onTabChange">
      <t-tab-panel value="L0" label="L0" :destroy-on-hide="false">
      </t-tab-panel>
      <t-tab-panel value="L1" label="L1" :destroy-on-hide="false">
      </t-tab-panel>
      <t-tab-panel value="L2" label="L2" :destroy-on-hide="false">
      </t-tab-panel>
      <t-tab-panel value="WASON" label="智控" :destroy-on-hide="false">
      </t-tab-panel>
      <t-tab-panel value="OSP" label="支撑" :destroy-on-hide="false">
      </t-tab-panel>
    </t-tabs>
    ...
    <div class="toolbar">
      ...
      <div class="toolbar-right">
        <t-tag theme="primary" variant="light" size="small">包含模块</t-tag>
        <t-tag theme="warning" variant="light" size="small">依赖关系</t-tag>
        <t-tag theme="success" variant="light" size="small">关联特性</t-tag>
        <t-tag theme="danger" variant="light" size="small">组件连接</t-tag>
      </div>
    </div>
