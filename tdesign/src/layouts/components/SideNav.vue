<template>
  <div :class="sideNavCls">
    ...
    >
      ...
      <template #operations>
        <span :class="versionCls"> {{ !collapsed ? '波分研发中心' : '' }} {{ pgk.version }} </span>
      </template>
    </t-menu>
...
import AssetLogoFull from '@/assets/logo-full5.svg?component';
import AssetLogo from '@/assets/logo-icon3.svg';
